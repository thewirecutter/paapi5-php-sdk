...
class VariationSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     */
    public function getPrice(): ?VariationSummaryPrice
    {
     ...
     * @return float|null
     */
    public function getVariationCount(): ?float
    {
     ...
     */
    public function getVariationDimensions(): ?array
    {
     ...
     * @return self
     */
    public function setVariationDimensions(?array $variationDimensions): self
    {
